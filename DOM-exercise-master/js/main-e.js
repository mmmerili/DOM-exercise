...
for(let i=0; i < picArray.length; i++) {
  console.log(picArray[i].description);

  header.appendChild(picArray[i].title);
  figure.appendChild(picArray[i].filename);
  figure.appendChild(picArray[i].caption);
  article.appendChild(header);
  article.appendChild(figure);
  article.appendChild(picArray[i].description);
